...
- models/ — 5 files (ware, sector, station, trade, ship)
- parsers/ — 3 files (cat_dat, game_xml, save_xml)
- extractors/ — 3 files (wares, localization, sectors)
- services/ — 2 files (cache, arbitrage)
- api/ — 2 files (handlers, routes)
